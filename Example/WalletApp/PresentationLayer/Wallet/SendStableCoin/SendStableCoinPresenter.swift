...
//                    usdtHex = "0x0"
//                } else {
//                    // For EVM chains, use erc20Balance - commented out since chain abstraction is disabled
//                    /*
...
//                    */
//                    
//                    // Set default values since chain abstraction is disabled
//                    usdcHex = "0x0"
//                    usdtHex = "0x0"
//                    usdsHex = "0x0"
//                }
...
//        AlertPresenter.present(message: "Chain abstraction transfers are currently disabled.", type: .error)
//        return
//
//        /*
//        do {
...
//        case .usds:
//            if selectedNetwork.usdsContractAddress.isEmpty {
//                throw Errors.unsupportedToken("USDS is not supported on this network")
//            }
//            tokenAddress = selectedNetwork.usdsContractAddress
//        }
//
//        // 3) Build the call for EVM - commented out since chain abstraction is disabled
//        /*
...
//        */
//        
//        // Return a dummy Call since chain abstraction is disabled
//        throw Errors.unsupportedToken("Chain abstraction transfers are currently disabled")
//    }
//
