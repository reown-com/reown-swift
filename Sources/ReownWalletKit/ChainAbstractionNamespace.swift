...
//        fatalError()
////        ret/*urn try await chainAbstractionClient.prepareDetailed(chainId: chainId, from: from, call: call, accounts: accounts, localCurrency: localCurrency, useLifi: false)*/
//    }
//
//    @available(*, message: "This method is experimental. Use with caution.")
